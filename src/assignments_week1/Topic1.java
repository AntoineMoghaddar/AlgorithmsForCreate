 ...
 */
public class Topic1 extends PApplet {
...
//                println("[DEBUG] adding " + i + " | New count: " + count); //TODO uncomment when wanting to see summation
    ...
    public void draw() {
        ...
        if (opt != -1) {
            ...
            switch (opt) {
                case 1 -> LetterByLetter(chars);
                case 2 -> LetterByLetterReversed(chars);
                case 3 -> occurencesLetter(chars);
                case 4 -> checkPalindrome(chars);
                case 5 -> randomIntegers();
    ...
    public static void main(String[] args) {
        String[] processingArgs = {"assignments_week1.Topic1"};
        Topic1 gui = new Topic1();
        PApplet.runSketch(processingArgs, gui);
    }
}